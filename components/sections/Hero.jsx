  ...
  return (
    <div className="max-w-5xl grid gap-10 md:gap-0 md:grid-cols-[2fr,1fr] mx-auto py-28 px-10 grid-cols-1 overflow-hidden">
      <div className="flex flex-col space-y-5 h-full justify-center">
        <h1 className="font-black tracking-tighter text-5xl md:text-7xl text-transparent bg-clip-text bg-gradient-to-br from-[#feabf1] to-[#033f8f] filter drop-shadow-sm">
          CYBERGENCE 2021
        </h1>
